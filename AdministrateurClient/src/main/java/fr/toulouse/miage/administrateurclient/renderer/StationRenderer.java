 ...
 */
package fr.toulouse.miage.administrateurclient.renderer;
...
public class StationRenderer implements ListCellRenderer{
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        if (value instanceof ObjMecanicien){
            ObjMecanicien mecano = (ObjMecanicien) value;
            renderer.setText(mecano.toString());
        }
        return renderer;
    }
